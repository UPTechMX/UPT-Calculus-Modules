...
class Module:
    ...
    def __job_density_threads(self):
        ...
        for h in range(0, num_partitions):
            ...
            _threads[h] = threading.Thread(target=self.__ModulejobDensity, args=(
            ...
            while error and count < 3:
                ...
                try:
                    with transaction.atomic():
                        ...
                        LogEvents("job density", "job density  module started: " + query,
                    ...
                    error = True
                    count += 1
                    LogEvents("job density ", "job density  module failed " +
